...
for j in range(0,300):   #seventy points, each time i increase the probability (and therefore the average degree = p*(n-1) ,  n is the number of nodes)
	G = nx.gnp_random_graph(num_nodes, 0.0001*j)
